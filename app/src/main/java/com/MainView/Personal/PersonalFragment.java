 ...
 */
    ...
    private void initBroadcast() {
        ...
        getActivity().registerReceiver(receiver,new IntentFilter("broadsend.logout"));
    }
...
//                        }
    ...
    private void initprofilePhotoView() {
        if (User.getInstance(getContext()).isLogged()) {
            ...
            profilePhotoView.setImageDrawable(getActivity().getDrawable(R.drawable.headphoto));
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == LOGINSUCCESS) {
            initprofilePhotoView();
        }
    }
